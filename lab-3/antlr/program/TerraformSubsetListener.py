...
class TerraformSubsetListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by TerraformSubsetParser#destroy.
    def enterDestroy(self, ctx:TerraformSubsetParser.DestroyContext):
        pass

    # Exit a parse tree produced by TerraformSubsetParser#destroy.
    def exitDestroy(self, ctx:TerraformSubsetParser.DestroyContext):
        pass
